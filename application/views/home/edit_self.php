				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<input id="password1" class="form-control" name="newpassword" placeholder="<?php echo _e('new_password_label'); ?>" type="password" />
							<span class="text-danger">
                        ...
                        <div class="form-group">
							...
							<input class="radiobtn" type="radio" name="gender" value="M" <?php if($gender === 'M') echo 'checked'; ?>> <?php echo _e('male'); ?><br>
  							<input class="radiobtn" type="radio" name="gender" value="F" <?php if($gender === 'F') echo 'checked'; ?>> <?php echo _e('female'); ?><br>
						</div>
						...
						<div class="form-group">
							...
							<input id="birthday" class="form-control datepicker" name="birthday" type="text" value="<?php echo $this->data['birthday']; ?>" /> 
							<span class="text-danger">
