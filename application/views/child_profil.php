<div>
	...
	<div style="text-align: center;">
		<img
			...
			class="img-circle" alt="<?php echo _e('missing_image');?>" height="200" style="background-color: #93DAFF; margin-bottom: 20px;">
	</div>
	<div class="baby container white-container" style="display: grid height:'120';">
		<div>
			...
			<div class="progress">
				<div class='progress-bar progress-bar-striped myProgress' role='progressbar'
                     	...
                     	aria-valuemax='<?php echo $max_score;?>' style='width: <?php echo $personal_social_value_pct;?>%'>
             	</div>
				<p id='prog_value0'></p>
			</div>
		</div>
			...
			<div class="progress">
				<div class='progress-bar progress-bar-striped myProgress' role='progressbar'
                     	value='<?php echo $fine_motor_value_pct;?>' aria-valuenow='<?php echo $fine_motor_value_pct;?>'
                 	 	aria-valuemin='0' aria-valuemax='<?php echo $max_score;?>' style='width: <?php echo $fine_motor_value_pct;?>%'>
                </div>
				<p id='prog_value1'></p>
			</div>
		</div>
			...
			<div class="progress">
				<div class='progress-bar progress-bar-striped myProgress' role='progressbar'
                     	value='<?php echo $language_value_pct;?>' aria-valuenow='<?php echo $language_value_pct;?>'
                 	 	aria-valuemin='0' aria-valuemax='<?php echo $max_score;?>' style='width: <?php echo $language_value_pct;?>%'>
                </div>
				<p id='prog_value2'></p>
			</div>
		</div>
			...
			<div class="progress">
				<div class='progress-bar progress-bar-striped myProgress' role='progressbar'
                     	value='<?php echo $gross_motor_value_pct;?>' aria-valuenow='<?php echo $gross_motor_value_pct;?>'
             	 		aria-valuemin='0' aria-valuemax='".$max_score."' style='width: <?php echo $gross_motor_value_pct;?>%'>
         	 	</div>
				<p id='prog_value3'></p>
			</div>
		</div>
