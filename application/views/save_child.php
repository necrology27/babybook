...
<?php if ($child_id != 0) { ?>
    <img src="<?php echo uploads_url() . getCurrentUserID() . "/" . $child_id . "/" . $this->image_model->get_def_img($child_id);?>" 
    		alt =" <?php echo _e('missing_image');?>" class='back-left' />
<?php } ?>
			...
			<div class="baby panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<input id="genetical_disorders" class="form-control" 
								name="genetical_disorders" placeholder="<?php echo _e('none_placeholder'); ?>" 
								type="text" value="<?php echo $genetical_disorders; ?>" /> 
						<span class="text-danger">
					...
					<div class="form-group">
						...
						<input id="other_disorders" class="form-control"
								name="other_disorders" placeholder="<?php echo _e('none_placeholder'); ?>" 
								type="text" value="<?php echo $other_disorders; ?>" /> 
						<span class="text-danger">
					...
					<div class="form-group">
						...
						<button name="cancel" type="reset" 
								onclick="location.href='<?php echo base_url();?>home'" class="btn btn-default">
