			...
			<div class="panel panel-default">
                ...
                echo form_open("user/forgot", $attributes); ?>
						...
						<div class="form-group">
							...
							<input id="email" class="form-control" name="email" placeholder="<?php echo _e('ex_mail'); ?>" type="text" value="<?php echo set_value('email'); ?>" /> 
						...
						<div class="form-group">
							<button name="submit" type="submit" class="btn btn-default"><?php echo _e('send_email_button'); ?></button>
						</div>
					</form>
