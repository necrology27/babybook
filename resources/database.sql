...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2017 at 12:16 PM
...
INSERT INTO `images` (`id`, `child_id`, `file_name`, `upload_date`, `age`, `title`, `description`) VALUES
...
(1, 10, 'Play Ball with Examiner', 'Roll the ball to the child and try to get the child to roll it or toss it back. You may need to roll the ball back and forth several times. Pass if the child rolls or tosses the ball purposefully toward you. (Handing the ball to you is not a pass.) '),
(1, 11, 'Imitate Activities', 'Ask the parent if the child imitates activities around the house such as dusting, wiping up, sweeping, vacuuming, or talking on the telephone. Pass if the parent reports that the child imitates any type of adult household activity.'),
(1, 12, 'Drink from Cup', 'Ask the parent if the child can hold a regular cup or glass and drink from it without help, spilling less than half of the liquid. The cup or glass may not have a lid or spout. Pass if the parent reports that the child does this.'),
(1, 13, 'Help in House', 'Ask the parent if the child helps at home by doing simple tasks like putting toys away, throwing trash away, or getting something for a parent when asked. Pass if the child actually helps rather than just imitates. The objective is to determine if the child understands and carries out a request to help. '),
(1, 14, 'Use Spoon/Fork', 'Ask the parent if the child uses a spoon or fork to eat. If so, how much does he/she spill? Pass if the child uses a spoon and/or fork and gets most of the food into the mouth, spilling little. The objective is to determine if the child is essentially self-sufficient in feeding.'),
(1, 15, 'Remove Garment', 'Ask the parent if the child can remove any of his/her clothing, and if so, what items of clothing. Pass if the child can remove items such as shoes that take some effort to remove, jacket, pants, or T-shirt. Do not pass hat, socks, diaper, slippers, or shoes that slip off easily. The objective is to see if the child can purposefully remove a garment in an effort at self-care. '),
(1, 16, 'Feed Doll', 'Place the doll and toy bottle on the table in front of the child. Tell the child to <q>feed the baby<q> and/or <q>give the baby the bottle.<q> Pass if the child places the bottle to the doll\'s mouth or obviously tries to put it to the mouth. If the child imitates breast-feeding, encourage him/her to use the bottle, as breast-feeding alone is not a pass. '),
(1, 17, 'Put on Clothing', 'Ask the parent if the child can put on any of his/her own clothing, and if so, which items. Pass if the child puts on any clothing, such as underpants, socks, shoes, jacket, etc. Shoes do not have to be tied, fastened, or on correct feet. A cap placed haphazardly on the head does not pass. '),
(1, 18, 'Brush Teeth,Help', 'Ask the parent if the child brushes his/her teeth with some help. If so, ask the parent to describe how this is done. Pass if the child is reported to hold the toothbrush and move it across the teeth in a brushing motion. There may be some help from the parent in directing the toothbrush but the child must do most of the brushing. The parent may oversee and put toothpaste on the brush. Score No Opportunity<q> if the parent has not allowed the child to try this. '),
(1, 19, 'Wash & Dry Hands', 'Ask the parent if the child can wash and dry his/her own hands without help, except for turning on faucets that are out of reach. Pass if the parent reports that the child does this, using soap and rinsing and drying well. '),
(1, 20, 'Name Friend', 'Ask the child to name some of his/her friends or playmates (not living with the child). Pass if the child gives the first name of at least one friend. Names of cousins or siblings are acceptable if they do not live with the child. Names of pets or imaginary friends are not acceptable. ');
INSERT INTO `skill_language` (`lang_id`, `skill_id`, `name`, `description`) VALUES
(1, 21, 'Put on T-Shirt', 'Ask the parent if the child can get his/her T-shirt or pullover on without help. Pass if the child can pull the shirt over his/her head and get his/her arms in the sleeves. The shirt may be on backwards or inside out. '),
(1, 22, 'Dress, No Help', 'Ask the parent if the child can dress without any help. Pass if the child can dress completely and correctly without help. He/she must usually pick out his/her own clothes (at least play clothes), and may have help only for tying shoelaces, and buttoning or zipping the back of a dress. A pass of Dress, No Help also passes Put on Clothing and Put on T-Shirt.'),
(1, 23, 'Play Board/Card Games', 'Ask the parent if the child plays simple board or card games, such as <q>Candy Land<q> or <q>Old Maid.<q> Specify that the child must really play and understand the game. Pass if the parent reports that the child understands and plays board or card games with others, sitting and taking turns.'),
(1, 24, 'Brush Teeth, No Help', 'Ask the parent if the child brushes his/her own teeth without help or supervision some of the time, including putting toothpaste on the brush and brushing all teeth with back and forth strokes at the gum line. Pass if the parent reports that the child brushes his/her teeth without help or supervision at least some of the time. (The parent should be advised to brush the child\'s teeth some of the time to ensure proper cleaning.) A pass of Brush Teeth, No Help also passes Brush Teeth with Help. '),
(1, 25, 'Prepare Cereal', 'Ask the parent if the child can prepare a bowl of cereal without help (other than being given items that are hard to reach), including getting the bowl, spoon, cereal, and milk, and pouring the cereal and milk into the bowl without spilling much. If the parent says the child cannot do this because the container of milk is too large, ask if the child could pour it from a nearly empty container, a small pitcher, or a glass. Pass if the parent reports that the child can do this, including pouring milk from any kind of container. '),
(1, 26, 'Follow to Midline', 'With the child lying on his/her back, hold the red yarn above the child\'s face at a height where he/she focuses on it (usually about 8 inches). Shake the yarn to attract the child\'s attention and move it slowly in an arc from one side of the child\'s body to the other several times. The movement of the yarn may be stopped to reattract the child\'s attention, and then continued. Pass if the child follows the yarn to the midpoint of the arc with eyes alone, or with head and eyes.'),
(1, 27, 'Follow Past Midline', '(Refer to Follow to Midline for administration procedure.) Pass if the child follows the yarn past the midpoint of the arc with eyes alone, or with head and eyes. A pass of Follow Past Midline also passes Follow to Midline. '),
(1, 28, 'Grasp Rattle', 'While the child is lying on his/her back or is being held by the parent, touch the backs or tips of the child\'s fingers with the handle of the rattle. Pass if the child grasps the rattle for a few seconds.'),
(1, 29, 'Hands Together', 'During the test while the child is lying on his/her back (not while cradled in the parents arms), notice if the hands are brought together at the midline of the body over the chest or at the mouth. Pass if you see the child bring his/her hands together in this manner. '),
(1, 30, 'Follow 180 Degrees', 'Pass if the child follows the yarn with head and eyes through the complete arc from one side of the body to the other. A pass of Follow 180 Degrees also passes Follow to Midline and Follow Past Midline.'),
(1, 31, 'Regard Raisin', 'With the child sitting on the parent\'s lap at the table, place a raisin directly in front of the child. The raisin should be placed on a surface that gives good contrast, such as a piece of white paper. Pass if the child clearly looks at the raisin.'),
(1, 32, 'Reaches', 'With the child sitting on the parents lap so that the child\'s elbows are level with the table top and his/her hands are on the table, place an object such as the rattle or the red yarn within easy reach and encourage the child to pick it up. Pass if you see the child reach toward or at least move his/her hands or arms in the direction of the object on the table. '),
(1, 33, 'Look for Yarn', 'While the child is sitting on the parent\'s lap, hold the red yarn high and attract the child\'s attention to it. When the child is looking at the yarn, drop it so that it falls out of sight. Do not move your hand or arm except to release the yarn. Repeat if the child\'s response is unclear. Pass if the child definitely looks for the yarn by looking down or toward the floor. '),
(1, 34, 'Rake Raisin', 'With the child sitting on the parent\'s lap so that his/her elbows are level with the table top and his/her hands are on the table, drop a raisin directly in front of the child within easy reach. If necessary, you may point to or touch the raisin to attract the child\'s attention. <q>0<q>-shaped cereal may be used in place of a raisin. Pass if the child picks up the raisin, using a raking motion with the entire hand. Make sure the raisin did not merely stick to the child\'s hand but was actually picked up. This item is also passed if the child passes Thumb-Finger Grasp. '),
(1, 35, 'Pass Cube', 'Notice whether the child passes a block from one hand to the other. To encourage this, give the child a block; then present a second block to the same hand. The child will often pass the first block to the other hand so that he/she can take the second block. Pass if you see the child transfer a block from one hand to the other without using his/her body, mouth. or the table.'),
(1, 36, 'Take 2 Cubes', 'Place 2 blocks on the table in front of the child. Encourage him/her to pick up the blocks, but do not hand them to the child. Pass if the child picks up the 2 blocks and holds one in each hand at the same time.'),
(1, 37, 'Thumb-finger Grasp', 'Pass if the child picks up the raisin by bringing together any part of the thumb and one or several fingers. A pass of Thumb Finger Grasp also passes Rake Raisin. '),
(1, 38, 'Bang 2 Cubes Held in Hands', 'Place a block in each of the child\'s hands and encourage him/her to bang them together. You may encourage the child to hit the blocks together by demonstrating with blocks held in your own hands. Do not touch or allow the parent to touch the child\'s hands or arms. If the child does not bang the blocks together, ask the parent if the child hits small objects together in this manner. Pass if the child holds one block in each hand and hits the blocks together, or if the parent reports that the child hits small objects together. Pots, pans, lids, or other large objects do not pass. '),
(1, 39, 'Put Block in Cup', 'Place 3 blocks and the cup on the table in front of the child. Encourage the child to put the blocks in the cup by demonstration and words. This demonstration may need to be repeated several times. Pass if the child places at least one block in the cup and releases it. '),
(1, 40, 'Scribbles', 'Place a piece of plain paper and a pencil on the table in front of the child. You may place the pencil in the child\'s hand and encourage him/her to scribble, but do not show him/her how to scribble. (Watch the child carefully and be prepared to prevent him/her from putting the pencil in mouth or eye.) Pass if the child makes purposeful marks on the paper. Fail accidental marks or stabbing with the pencil. '),
(1, 41, 'Dump Raisin, Demonstrated', 'Show the child 2 or 3 times how to dump the raisin out of the bottle. Then ask the child to get it out. (Do not use the word <q>dump.\') Pass if the child dumps the raisin out of the bottle or rakes the raisin close to the opening and then dumps it out. Do not pass if the child removes the raisin with a finger.'),
...
(1, 43, 'Tower of 4 Cubes', 'With the child sitting high enough at the table so that elbows are level with table top and hands are on the table, place the blocks on the table in front of the child. Encourage the child to stack them by demonstration and words. It may be helpful to hand the blocks to the child, one at a time. Three trials may be given. Pass Tower of 4, 6, or 8 Cubes, depending upon the greatest number of blocks the child stacks in three trials. '),
(1, 44, 'Tower of 6 Cubes', 'With the child sitting high enough at the table so that elbows are level with table top and hands are on the table, place the blocks on the table in front of the child. Encourage the child to stack them by demonstration and words. It may be helpful to hand the blocks to the child, one at a time. Three trials may be given. Pass Tower of 4, 6, or 8 Cubes, depending upon the greatest number of blocks the child stacks in three trials. '),
(1, 45, 'Imitate Vertical Line', 'The child should be seated at the table at a comfortable writing level. Place a pencil and a piece of plain paper in front of the child and tell him/her to draw lines like yours. On that paper, demonstrate how to draw vertical lines, drawing toward the child. Do not guide the child\'s hand. Three trials may be given. Pass if the child makes 1 line or more on the paper, at least 2 inches long, and not varying from your vertical line by more than 30 degrees (see example). Lines do not have to be perfectly straight. '),
(1, 46, 'Tower of 8 Cubes', 'With the child sitting high enough at the table so that elbows are level with table top and hands are on the table, place the blocks on the table in front of the child. Encourage the child to stack them by demonstration and words. It may be helpful to hand the blocks to the child, one at a time. Three trials may be given. Pass Tower of 4, 6, or 8 Cubes, depending upon the greatest number of blocks the child stacks in three trials. '),
(1, 47, 'Thumb Wiggle', 'Demonstrate with one or both hands by making a fist with your thumb pointing upward. Wiggle only your thumb. Tell the child to wiggle his/her thumb (or thumbs) the same way. Do not help put the child\'s hand into position. You may tell the child to make a <q>thumbkin<q>. Pass if the child moves the thumb of either or both hands without moving any other fingers.'),
(1, 48, 'Copy Circle', 'Give the child a pencil and piece of plain paper. Show him/her the circle on the back of the test form. Without naming it or moving your finger or pencil to show how to draw it, tell the child to draw one like the picture. Three trials may be given. Pass any form approximating a circle that is closed or very nearly closed. Fail continuous spiral motions. '),
(1, 49, 'Draw Person 3 Parts', 'Give the child a pencil and a piece of plain paper. Tell him/her to draw a picture of a person (boy, girl, Mommy, Daddy, etc.) Be sure the child has finished before scoring the drawing. Pass if the child has drawn 3 or more body parts. A pair (ears, eyes, arms, hands, legs, feet) is considered one part. To get credit, both parts of the pair must be drawn unless the drawing is in profile (in which case one eye, ear, etc., gets credit.) Make note in your test observations of any unusual drawing, even though the child has identified the acceptable parts. '),
(1, 50, 'Copy +', 'Give the child a pencil and a piece of plain paper. Show him/her the cross on the back of the test form. Without naming it or moving your finger or pencil to show how to draw it, tell the child to <q>draw one like the picture.<q> Three trials may be given. Pass if the child draws 2 lines which intersect at least somewhat near the midpoint. The lines do not need to be exactly straight, but the intersecting lines do need to be drawn using only 2 strokes. '),
(1, 51, 'Pick Longer Line', 'Making sure they are presented vertically, show the child the parallel lines on the back of the test form and ask the child, <q>Which line is longer?<q> (Do not say <q>bigger.<q>) After the child has pointed to a line, turn the paper upside down and ask the question again. Turn the paper upside down again and repeat this a third time. If the child does not answer correctly all three times, repeat the question three more times, turning the paper each time. Pass if the child picks the longer line 3 out of 3 times or 5 out of 6 times.'),
(1, 52, 'Copy Square Demonstrated', 'If the child is unable to copy the square from the picture, show him/her how to draw it by drawing two opposite (parallel) sides first and then the other two opposite sides (rather than drawing the square with a continuous motion).Three demonstrations and trials may be given. Pass if the child draws a figure with straight lines and 4 square corners. The corners may be formed by lines that intersect but the corners must be approximately right angles (not rounded or pointed). The length should be less than 2 times the width. '),
(1, 53, 'Draw Person 6 Parts', 'Give the child a pencil and a piece of plain paper. Tell him/her to draw a picture of a person (boy, girl, Mommy, Daddy, etc.) Be sure the child has finished before scoring the drawing. - Pass if the child has drawn 6 or more body parts. (See criteria under 3 parts.) A pass of Draw Person - 6 Parts also passes Draw Person - 3 Parts. '),
(1, 54, 'Copy Square', 'Give the child a pencil and a piece of plain paper. Show him/her the square on the back of the test form. Without naming it or moving your finger or pencil to show how to draw it, tell the child to <q>draw one like the picture.<q> Three trials may be given. Pass if the child draws a figure with straight lines and 4 square corners. The corners may be formed by lines that intersect but the corners must be approximately right angles (not rounded or pointed). The length should be less than 2 times the width. '),
(1, 55, 'Respond to Bell', 'Hold the bell so that the child cannot see it (to the side and a little behind the child\'s ear). Ring the bell softly_ If the child does not respond, try again later in the test session. Pass if the child responds in any way, such as eye movement, change in expression, change in breathing rate, or any other change in activity. '),
(1, 56, 'Vocalizes', 'During the test, listen for sounds other than crying, such as small throaty sounds or short vowel sounds (<q>uh,<q> <q>eh<q>). If none are heard, ask the parent if the child makes these sounds. Pass if you hear the child make such sounds or if the parent reports that the child does this. Pass this item also if any other vocalization items are passed. '),
(1, 57, 'Ooo/aah', 'Listen for the child to make vowel sounds, such as <q>o o or <q>aah.<q> if these sounds are not heard, ask the parent if the child has made these sounds. Pass if you hear vowel sounds or if the parent reports that the child does this,'),
(1, 58, 'Laughs', 'Listen for the child to laugh aloud. If this is not heard, ask the parent if the child does this. Pass if you hear the child laugh aloud or if the parent reports that he/she does this. '),
(1, 59, 'Squeals', 'Listen for the child to make high-pitched, happy squealing sounds. If this is not heard, ask the parent if the child does this. Pass if these sounds are heard or if the parent reports that the child does this.'),
(1, 60, 'Turn to Rattling Sound', 'Stand behind the child while he/she is facing the parent, sitting either on the parent\'s lap or on the table. If necessary, ask the parent to use the red yarn to get the child\'s attention. Put one block in the cup and hold it with your hand covering the top. Being careful to keep the cup quiet while moving into position, bring the cup 6-12 inches from the child\'s ear but out of the child\'s line of vision. Shake the cup gently, making a soft, low sound. Repeat with the other ear. Pass if the child responds by turning toward the sound on both sides.'),
(1, 61, 'Turn to Voice', 'While the child is facing the parent, either seated on the parent\'s lap, seated on the table, or held in the parent\'s arms, approach the child from behind to within 6-12 inches of either ear. Placing your hand between your mouth and the child so that the child does not respond to feeling your breath rather than to the sound, whisper the child\'s name several times. Repeat with the other ear. Pass if the child turns to the direction of your voice on both sides.'),
(1, 62, 'Single Syllables', 'Listen for the child to use single syllables consisting of a consonant and a vowel, such as <q>b <q>da,<q> <q>ga,<q> or <q>ma.<q> If this is not heard, ask the parent if the child does this. Pass if you hear such sounds or if the parent reports that the child does this. '),
(1, 63, 'Imitate Speech Sounds', 'Repeat a sound several times (such as a cough, clicking of the tongue, or kissing sound) and see if the child imitates you. If the child does not respond, ask the parent if the child imitates any speech sounds. Emphasize that the sounds must be initiated by the other person, not the child. Pass if you hear the child imitate your sound or if the parent reports that the child imitates the speech sounds of others. '),
(1, 64, 'Dada/Mama Non-specific', 'Listen for the child to say <q>dada<q> or <q>mama<q> during the test. If this is not heard, ask the parent if the child has said this. The words do not necessarily have to refer to a parent. Pass if the child says either <q>dada<q> or <q>mama,<q> or if the parent reports that the child does this. '),
(1, 65, 'Combine Syllables', 'Listen for the child to repeat the same syllable 3 or more times, such as <q>dadadada<q> or <q>gagagaga.<q> If this is not heard ask the parent if the child does this. Pass if the child does this or if the parent reports that the child does this. '),
...
(1, 67, 'Dada/Mama Specific', 'Listen for the child to say <q>Dada<q> to the father or <q>Mama<q> to the mother during the test. If this is not heard, ask the parent if the child does this. Pass if the child uses either <q>Dada<q> or <q>Mama<q> meaningfully, or if the parent reports that the child does this. Also pass other words for mother and father used by various cultures, such as <q>Papa.<q> A pass of this item also passes Dada/Mama Nonspecific'),
(1, 68, 'One Word', 'Acceptable words are any words other than <q>Mama,<q> <q>Dada,<q> or names of family members and pets.'),
(1, 69, '2 Words', 'Acceptable words are any words other than <q>Mama,<q> <q>Dada,<q> or names of family members and pets.'),
(1, 70, '3 Words', 'Acceptable words are any words other than <q>Mama,<q> <q>Dada,<q> or names of family members and pets.'),
(1, 71, '6 Words', 'Acceptable words are any words other than <q>Mama,<q> <q>Dada,<q> or names of family members and pets.'),
(1, 72, 'Point 2 Pictures', 'Be sure to administer the Name Pictures items first. If the child names less than 4 pictures correctly, administer this item. Show the child the pictures on the back of the form. Tell the child to <q>Point to the bird - man - dog - cat (kitty) - horse.<q> Name only one picture at a time, and wait for the child to point before naming the next picture. Pass Point to 2 Pictures if the child correctly points to (or names) 2 or 3 pictures. '),
(1, 73, 'Combine Words', 'Listen for the child to combine at least 2 words to make a meaningful phrase that indicates an action. If this is not heard, ask the parent if the child does this. Pass if you hear the child do this, or if the parent reports that the child does this. Examples: <q>play ball,<q> <q>want drink,<q> <q>see that,<q> <q>go bye-bye.<q> '),
(1, 74, 'Name 1 Picture', 'Show the child the pictures on the back of the form. Point to the cat, bird, horse, dog, and man one at a time, and ask <q>What is this?<q> Pass Name 1 Picture according to the number of pictures correctly named. Pass if the child uses the name of a pet, providing it is the same animal as pictured. <q>Daddy<q> or <q>boy<q> are acceptable answers for the man. '),
(1, 75, 'Body Parts-6', 'Show the doll to the child. Tell the child, <q>Point to the doll\'s nose - eyes - ears - mouth - hands -feet - tummy hair,<q> naming them one al a time. Pass if the child correctly points to at least 6 body parts. If the parent indicates <q>stomach<q> or <q>belly<q> are used, pass either of these if it is correctly identified. <q>Belly-button<q> is not a pass. '),
(1, 76, 'Point 4 Pictures', 'Be sure to administer the Name Pictures items first. If the child names less than 4 pictures correctly, administer this item. Show the child the pictures on the back of the form. Tell the child to <q>Point to the bird - man - dog - cat (kitty) - horse.<q> Name only one picture at a time, and wait for the child to point before naming the next picture. Pass Point to 4 Pictures if the child correctly points to (or names) 4 or 5 pictures. A pass of Point to 4 Pictures also passes Point to 2 Pictures. '),
(1, 77, 'Speech-Half Understandable', 'Throughout the test, notice the intelligibility of the child\'s speech (pronunciation, enunciation, actual words as opposed to <q>jibberish,<q> etc.) Pass Half Understandable if you have understood at least half of the child\'s speech.'),
(1, 78, 'Name 4 Pictures', 'Show the child the pictures on the back of the form. Point to the cat, bird, horse, dog, and man one at a time, and ask <q>What is this?<q> Pass Name 4 Pictures according to the number of pictures correctly named. Pass if the child uses the name of a pet, providing it is the same animal as pictured. <q>Daddy<q> or <q>boy<q> are acceptable answers for the man. '),
(1, 79, 'Know 2 Actions', 'Show the child the pictures on the back of the form. Instruct the child to point to the correct picture as the following questions are asked: <q>Which one flies?<q> <q>Which one says meow?<q> <q>Which one talksT <q>Which one barks?<q> <q>Which one gallops?<q>Pass Know 2 Actions if 2 or 3 pictures are pointed to correctly.  '),
(1, 80, 'Know 2 Adjectives', 'Ask the child the following questions, one at a time: <q>What do you do when you are cold?<q>  <q>What do you do when you are tired?<q>  <q>What do you do when you are hungry?<q> Pass Know 2 Adjectives depending upon the number of questions  answered correctly. Examples of correct answers: Cold - Put on coat, go inside, cover up. (Do not pass an answer about having a cold, such as <q>cough<q> or <q>take medicine.<q>)  Tired - Go to bed, lie down, sleep. Hungry - Eat, have lunch, ask for something to eat.'),
(1, 81, 'Name 1 Color', 'Place a red, a blue, a yellow, and a green block on the table in front of the child. Point to one block  and ask the child, <q>What color is this?<q> After the child answers, move the blocks around and ask  the child to tell you the color of another block. Repeat for all four colors. Pass Name 1 Color if the child correctly names 1, 2, or 3 colors. '),
(1, 82, 'Use of 2 Objects', 'Ask the child the following questions, one at a time: <q>What do you do with a cup?<q>  <q>What is a chair used for?<q> <q>What is a pencil .used for?<q> Pass Use of 2 Objects depending upon the number of questions answered  correctly. Action words such as <q>drink,<q> <q>sit,<q> and <q>write<q> must be included in the answers.  Unconventional uses such as <q>pour<q> for cup or <q>climb on<q> for chair are acceptable. Answers such  as <q>milk<q> for cup or <q>table<q> for chair are unacceptable.'),
(1, 83, 'Count 1 Block', 'Put 8 blocks on the table in front of the child. Place a piece of paper next to the blocks. Tell the  child, <q>Put one block on the paper.<q> When the child appears to be finished, ask <q>How many blocks  are on the paper?<q> Pass if the child places one block and says that one block is on the paper.  '),
(1, 84, 'Use of 3 Objects', 'Ask the child the following questions, one at a time: <q>What do you do with a cup?<q>  <q>What is a chair used for?<q> <q>What is a pencil .used for?<q> Pass Use of 3 Objects depending upon the number of questions answered  correctly. Action words such as <q>drink,<q> <q>sit,<q> and <q>write<q> must be included in the answers.  Unconventional uses such as <q>pour<q> for cup or <q>climb on<q> for chair are acceptable. Answers such  as <q>milk<q> for cup or <q>table<q> for chair are unacceptable.'),
(1, 85, 'Know 4 Actions', 'Show the child the pictures on the back of the form. Instruct the child to point to the correct picture  as the following questions are asked: <q>Which one flies?<q> <q>Which one says meow?<q> <q>Which one talksT <q>Which one barks?<q> <q>Which one  gallops?<q> Pass Know 4 Actions if 4 or 5 pictures are pointed to correctly.'),
(1, 86, 'Speech-All Understandable', 'Throughout the test, notice the intelligibility of the child\'s speech (pronunciation, enunciation, actual words as opposed to <q>jibberish,<q> etc.) Pass All Understandable if you have understood all or nearly all of what the child has said.  '),
(1, 87, 'Understand 4 Prepositions', 'While you and the child are standing, give him/her a block. Give the following directions to the Pchild, one at a time: <q>Put the block on the table.<q> <q>Put the block under the table.<q> <q>Put the block inPfront of me.<q> <q>Put the block behind me.<q> Pick up, or have the child pick up the block between Pdirections.PPass if the child performs all four tasks correctly.'),
(1, 88, 'Name 4 Colors', 'Place a red, a blue, a yellow, and a green block on the table in front of the child. Point to one block Pand ask the child, <q>What color is this?<q> After the child answers, move the blocks around and ask Pthe child to tell you the color of another block. Repeat for all four colors. Pass Name 4 Colors if the child correctly names 4 colors.PA pass of Name 4 Colors also passes Name 1 Color.P'),
(1, 89, 'Define 5 Words', '   Make sure the child is listening to you and then say:P<q>I am going to say a word and I want you to tell me what it is.<q>PAsk each word one at a time:P<q>What is a ball - lake - desk - house - banana - curtain fence - ceiling?<q>PEach word may be asked 3 times if necessary. You may say <q>Tell me something about it,<q> but do Pnot ask the child to tell you what the object is for or what to do with it.PPass Define 5 Words if the child defines 5 or 6 words acceptably in terms of: P1) use, 2) shape, 3) what it is made of, or 4) general category. Pass Define 7 Words if the child defines 7 or 8 words acceptably. Examples of correct answers: Ball - bounces, circle, toy, play with Lake - water, fish in itPDesk - write on it, put papers in, wood House - to live in, made of wood (bricks, etc.) Banana - fruit, to eat Curtain - to cover the window, so people can\'t see in  Fence - to keep the dog in, to climb on, around the yard  Ceiling - top of the room, to keep the rain off A pass of Define 7 Words also passes Define 5 Words.  '),
(1, 90, 'Know 3 Adjectives', 'Ask the child the following questions, one at a time: <q>What do you do when you are cold?<q>  <q>What do you do when you are tired?<q>  <q>What do you do when you are hungry?<q> Pass Know 3 Adjectives depending upon the number of questions  answered correctly. Examples of correct answers: Cold - Put on coat, go inside, cover up. (Do not pass an answer about having a cold, such as <q>cough<q> or <q>take medicine.<q>)  Tired - Go to bed, lie down, sleep. Hungry - Eat, have lunch, ask for something to eat.'),
(1, 91, 'Count 5 Blocks', '   Put 8 blocks on the table in front of the child. Place a piece of paper next to the blocks. Tell the child, <q>Put five blocks on the paper.<q> When the child appears to be finished, ask, <q>How many  blocks are on the paper?<q> Pass if the child places 5 blocks and says that 5 blocks are on the paper. The child does not have  to count each block out loud. Only counting (<q>1, 2, 3, 4, 5<q>) does not pass; the child must state <q>5<q>  separately. '),
(1, 92, 'Opposites-2', 'Say each of the following sentences slowly and distinctly, one at a time, and wait for the child to fill  in the blank. Each sentence may be repeated 3 times if necessary. <q>If a horse is big, a mouse is  <q>If fire is hot, ice is  <q>If the sun shines during the day, the moon shines during the  Pass if the child completes two sentences correctly. Examples of correct answers: Big - little, small, tiny Hot - cold, cool, freezing, frozen (wet, melting, or water are incorrect)  Day - night, dark, black, evening '),
(1, 93, 'Define 7 Words', '   Make sure the child is listening to you and then say:<q>I am going to say a word and I want you to tell me what it is.<q>Ask each word one at a time:<q>What is a ball - lake - desk - house - banana - curtain fence - ceiling?<q>Each word may be asked 3 times if necessary. You may say <q>Tell me something about it,<q> but do not ask the child to tell you what the object is for or what to do with it.Pass Define 5 Words if the child defines 5 or 6 words acceptably in terms of: 1) use, 2) shape, 3) what it is made of, or 4) general category. Pass Define 7 Words if the child defines 7 or 8 words acceptably.Examples of correct answers: Ball - bounces, circle, toy, play withLake - water, fish in itDesk - write on it, put papers in, woodHouse - to live in, made of wood (bricks, etc.)Banana - fruit, to eatCurtain - to cover the window, so people can\'t see in Fence - to keep the dog in, to climb on, around the yard Ceiling - top of the room, to keep the rain offA pass of Define 7 Words also passes Define 5 Words. '),
(1, 94, 'Equal Movements', 'While the child is lying on his/her back, watch the activity of the child\'s arms and legs Pass if the child moves arms and legs equally. Fail if one arm and/or leg does not move as much as the other.'),
(1, 95, 'Lift Head', 'Place the child on his/her stomach on a fiat surface. Pass if the child at least momentarily lifts his/her head so that the chin is off the surface without  being turned to either side or if the parent reports that the child can do this. '),
(1, 96, 'Head up 45 Degrees', 'Place the child on his/her stomach on a flat surface. Pass if the child lifts his/her head so that his/her face makes an approximate 45 degree angle with the surface for at least several seconds. The child will be looking at the table in front of him/her. A pass of Head Up 45 Degrees also passes Lift Head. '),
(1, 97, 'Head up 90 Degrees', 'Place the child on his/her stomach on a flat surface. Pass if the child lifts head and chest up so that his/her face makes a 90 degree angle with the sur-  face for at least several seconds. The child will be looking straight ahead and will usually be sup-  ported on his/her forearms. A pass of Head Up 90 Degrees also passes Head Up 45 Degrees and Lift Head. '),
(1, 98, 'Sit-Head Steady', ' Hold the child in a sitting position. Pass if the child holds his/her head upright and steady with no bobbing motion for at least several  seconds. '),
(1, 99, 'Bear Weight on Legs', 'Hold the child in a standing position so that his/her feet rest on the table. Slowly loosen your hand  support to allow the child\'s weight to be supported on his/her legs and feet. Pass if the child supports his/her weight on the legs for several seconds. '),
(1, 100, 'Chest Up-Arm Support', 'Place the child on his/her stomach on a flat surface. Pass if the child lifts his/her head and chest off the surface using the support of outstretched arms, so that he/she is looking straight ahead or up. '),
...
(1, 102, 'Pull to Sit-No Head Lag', 'Place the child on his/her back. Grasp the child\'s hands and wrists and gently and slowly pull him/her to a sitting position. If there is immediate head lag, do not continue to pull the child all the way to the sitting position. Pass if the child\'s head does not lag at any time while the body is being pulled up. The child will also <q>pull<q> with you, using shoulder and neck muscles. '),
(1, 103, 'Sit-No Support', 'Hold the child in a sitting position on the table. Making sure the child does not fall, slowly remove your hands. Pass if the child sits alone for 5 seconds or more. The child may put hands on legs or on the table  for support. '),
(1, 104, 'Stand Holding On', 'Place the child in a standing position holding on to a solid object (not a person). Pass if the child stands holding on for 5 seconds or more. '),
(1, 105, 'Pull to Stand', 'Place the child sitting on the floor beside a chair or low table. Encourage him/her to stand up by  putting a toy on the seat of the chair or on the table. Pass if the child pulls himself/herself to a standing position. '),
(1, 106, 'Get to Sitting', '  While the child is lying down (on back or stomach), crawling, or standing holding on, encourage   him/her to get into a sitting position. If this is not seen, ask the parent if the child can get into a sitting position by himself/herself. Pass if you see the child do this or if the parent reports that the child can do this. '),
(1, 107, 'Stand-2 Seconds', 'Place the child standing on the floor. After the child seems balanced, try to remove the support.  Pass if you see the child stand without any support for 2 or more seconds.'),
(1, 108, 'Stand Alone', 'Administration procedure is the same as for Stand - 2 Seconds. Pass if the child stands alone 10 or more seconds. A pass of Stand Alone also passes Stand - 2 Seconds, and Stand Holding On. '),
(1, 109, 'Stoop and Recover', 'While the child is standing on the floor away from all support, place a toy or ball on the floor and  encourage the child to pick it up. Pass if the child stoops to pick up the object and returns to standing without holding on or sitting  down.'),
(1, 110, 'Walk Well', 'Watch the child walk. Pass if the child has good balance, rarely falls, and does not tip from side to side. '),
(1, 111, 'Walk Backwards', 'Encourage the child to walk backwards by demonstration, or notice if the child does this during the  test. If you do not see the child do this, ask the parent if the child walks backwards, possibly when  pulling a toy or opening a door or drawer. Pass if the child takes several steps backwards without sitting down, or if the parent reports that  the child can do this. '),
(1, 112, 'Runs', 'Encourage the child to run, possibly by throwing the ball for him/her to chase.  Pass if the child can run (not fast walk) smoothly without falling or tripping.  '),
(1, 113, 'Walk Up Steps', 'Ask the parent how the child gets up steps. Pass if the child walks up steps. The child may use a rail or wall for support, but may not hold on  to a person. '),
(1, 114, 'Kick Ball Forward', 'Place the ball about 6 inches in front of the standing child. Tell him/her to kick it. You may show the  child how to do this. Pass if the child kicks the ball forward without holding on to any support. Sliding or pushing the  ball with the foot, hitting the ball on the back swing, or stepping on the ball are failures. '),
(1, 115, 'Jump Up', 'Tell the child to jump. You may show the child how to do this. Pass if the child jumps, getting both feet off the floor at the same time. The child does not have to  land in the same spot. The child may not run before jumping, or hold on to any support. '),
(1, 116, 'Throw Ball Overhand', 'Give the child the ball and stand at least 3 feet from him/her. Tell the child to throw the ball to you using an overhand throw. You may show the child how to throw overhand. Three trials may be  given. Pass if the child throws the ball within arm\'s reach of you between your knees and head, using an  overhand throw (not sideways, or underhand). The ball may bounce before it reaches you if it was between your knees and head before beginning the downward arc. Throwing the ball directly  downward or away from you are failures. '),
(1, 117, 'Broad Jump', 'Place a piece of paper (8-1/2<q> by 11<q>) on the floor and show the child how to do a standing broad jump across the width of the paper (8-1/2<q>). Then tell the child to do it. You may give 3 trials, if  necessary. Pass if the child jumps, with both feet together, over the paper without touching it.  '),
(1, 118, 'Balance-Each Foot 1 Second', 'Have the child stand away from all support. Show the child how to balance on one foot. Tell  him/her to do this as long as he/she can, giving 3 trials (unless he/she balances for 6 seconds or  more on the first trial). Record the longest time of these three trials. Then tell the child to balance  on the other foot, giving 3 trials if necessary. Record the longest time of these three trials. Pass the appropriate balancing item or items according to the shortest of these 2 recorded times.  (Example: if the longest time for the right foot is 3 seconds and the longest time for the left foot is  5 seconds, the child passes balancing items for 1, 2, and 3 seconds.) A pass of 2, 3, 4, 5, or 6 seconds also passes all lower items. (For example, a pass of Balance-  Each Foot — 3 Seconds also passes Balance - Each Foot 1 Second and Balance - Each Foot 2  Seconds.) '),
(1, 119, 'Balance-Each Foot 2 Seconds', 'Have the child stand away from all support. Show the child how to balance on one foot. Tell  him/her to do this as long as he/she can, giving 3 trials (unless he/she balances for 6 seconds or  more on the first trial). Record the longest time of these three trials. Then tell the child to balance  on the other foot, giving 3 trials if necessary. Record the longest time of these three trials. Pass the appropriate balancing item or items according to the shortest of these 2 recorded times.  (Example: if the longest time for the right foot is 3 seconds and the longest time for the left foot is  5 seconds, the child passes balancing items for 1, 2, and 3 seconds.) A pass of 2, 3, 4, 5, or 6 seconds also passes all lower items. (For example, a pass of Balance-  Each Foot — 3 Seconds also passes Balance - Each Foot 1 Second and Balance - Each Foot 2  Seconds.) '),
(1, 120, 'Hops', 'With the child away from all support, tell him/her to hop on one foot. You may show the child how to  do this Pass if the child hops on one foot 2 or more times in a row, either in place or over a distance, with-  out holding on to anything. '),
(1, 121, 'Balance-Each Foot 3 Seconds', 'Have the child stand away from all support. Show the child how to balance on one foot. Tell  him/her to do this as long as he/she can, giving 3 trials (unless he/she balances for 6 seconds or  more on the first trial). Record the longest time of these three trials. Then tell the child to balance  on the other foot, giving 3 trials if necessary. Record the longest time of these three trials. Pass the appropriate balancing item or items according to the shortest of these 2 recorded times.  (Example: if the longest time for the right foot is 3 seconds and the longest time for the left foot is  5 seconds, the child passes balancing items for 1, 2, and 3 seconds.) A pass of 2, 3, 4, 5, or 6 seconds also passes all lower items. (For example, a pass of Balance-  Each Foot — 3 Seconds also passes Balance - Each Foot 1 Second and Balance - Each Foot 2  Seconds.) '),
(1, 122, 'Balance-Each Foot 4 Seconds', 'Have the child stand away from all support. Show the child how to balance on one foot. Tell  him/her to do this as long as he/she can, giving 3 trials (unless he/she balances for 6 seconds or  more on the first trial). Record the longest time of these three trials. Then tell the child to balance  on the other foot, giving 3 trials if necessary. Record the longest time of these three trials. Pass the appropriate balancing item or items according to the shortest of these 2 recorded times.  (Example: if the longest time for the right foot is 3 seconds and the longest time for the left foot is  5 seconds, the child passes balancing items for 1, 2, and 3 seconds.) A pass of 2, 3, 4, 5, or 6 seconds also passes all lower items. (For example, a pass of Balance-  Each Foot — 3 Seconds also passes Balance - Each Foot 1 Second and Balance - Each Foot 2  Seconds.) '),
(1, 123, 'Balance-Each Foot 5 Seconds', 'Have the child stand away from all support. Show the child how to balance on one foot. Tell  him/her to do this as long as he/she can, giving 3 trials (unless he/she balances for 6 seconds or  more on the first trial). Record the longest time of these three trials. Then tell the child to balance  on the other foot, giving 3 trials if necessary. Record the longest time of these three trials. Pass the appropriate balancing item or items according to the shortest of these 2 recorded times.  (Example: if the longest time for the right foot is 3 seconds and the longest time for the left foot is  5 seconds, the child passes balancing items for 1, 2, and 3 seconds.) A pass of 2, 3, 4, 5, or 6 seconds also passes all lower items. (For example, a pass of Balance-  Each Foot — 3 Seconds also passes Balance - Each Foot 1 Second and Balance - Each Foot 2  Seconds.) '),
(1, 124, 'Heel-To-Toe Walk', 'Demonstrate how to walk in a straight line placing the heel of one foot in front of and touching the  toe of the other. Walk about 8 steps like this and then tell the child to do it. (You may compare this  to a tight-rope walk.) If necessary, give several demonstrations. Allow 3 trials if needed. Pass if the child can walk in a straight line for 4 or more steps placing the heel no more than  1 inch in front of the toe, without holding on to any support.'),
(1, 125, 'Balance-Each Foot 6 Seconds', 'Have the child stand away from all support. Show the child how to balance on one foot. Tell  him/her to do this as long as he/she can, giving 3 trials (unless he/she balances for 6 seconds or  more on the first trial). Record the longest time of these three trials. Then tell the child to balance  on the other foot, giving 3 trials if necessary. Record the longest time of these three trials. Pass the appropriate balancing item or items according to the shortest of these 2 recorded times.  (Example: if the longest time for the right foot is 3 seconds and the longest time for the left foot is  5 seconds, the child passes balancing items for 1, 2, and 3 seconds.) A pass of 2, 3, 4, 5, or 6 seconds also passes all lower items. (For example, a pass of Balance-  Each Foot — 3 Seconds also passes Balance - Each Foot 1 Second and Balance - Each Foot 2  Seconds.) ');
...
CREATE TABLE `users` (
  ...
  `measurement` enum('SI (metre, kilogram)','English units(yard, stone)') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `votes` (
  `user_id` int(11) DEFAULT NULL,
  `post_id` int(11) DEFAULT NULL,
  `votes_value` tinyint(1) DEFAULT NULL,
...
--
ALTER TABLE `children`
  MODIFY `child_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=404;
--
