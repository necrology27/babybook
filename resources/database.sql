...
(2, 90, 'Három melléknevet ismer', 'A gyermeknek a következő kérdéseket tesszük fel, egyszerre egyet: <q>Mit csinálsz, ha fáradt vagy?</q>\r\n(aludni megyek, leülök, pihenek)\r\n<q>Mit csinálsz, ha fázol?</q> (kabátot veszek, bemegyek, meggyújtom a kályhát).\r\nNem fogadható el, ha a gyermek azt feleli: köhögök, gyógyszert kapok vagy bármi mást mond,\r\nami arra vonatkozik, hogy megfázott. Ebben az esetben nem értette a kérdést.\r\n<q>Mit csinálsz, ha éhes vagy?</q>(eszem, vacsorázom, kérek valamit enni.)\r\nÉrtékelés: Elfogadható, ha gyerek logikusan felel a három kérdésre.\r\nNéhány jó válaszra adtunk példát.'),
...
(1, 57, 'Ooo/aah', 'Listen for the child to make vowel sounds, such as <q>o o </q> or <q>aah.</q> if these sounds are not heard, ask the parent if the child has made these sounds. Pass if you hear vowel sounds or if the parent reports that the child does this,'),
...
(1, 62, 'Single Syllables', 'Listen for the child to use single syllables consisting of a consonant and a vowel, such as <q>b </q><q>da,</q> <q>ga,</q> or <q>ma.</q> If this is not heard, ask the parent if the child does this. Pass if you hear such sounds or if the parent reports that the child does this. '),
...
(1, 117, 'Broad Jump', 'Place a piece of paper (8-1/2 inch by 11 inch) on the floor and show the child how to do a standing broad jump across the width of the paper (8-1/2 inch). Then tell the child to do it. You may give 3 trials, if  necessary. Pass if the child jumps, with both feet together, over the paper without touching it.  '),
